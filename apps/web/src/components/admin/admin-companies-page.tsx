          ...
          <section className="grid gap-6 xl:grid-cols-[420px_minmax(0,1fr)]">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  autoComplete="off"
                  className="min-h-28 border-[var(--s2ee-border)] bg-[var(--s2ee-surface-soft)] shadow-none"
                  ...
                  placeholder="Equipe produit, cloud et data"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  autoComplete="off"
                  className="min-h-32 border-[var(--s2ee-border)] bg-[var(--s2ee-surface-soft)] shadow-none"
                  ...
                  <div className="border border-[var(--s2ee-border)] bg-white p-5" key={entry.id}>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      ...
                      <Button
                        className="s2ee-command"
                        onClick={async () => {
                          if (!window.confirm(`Supprimer ${entry.name} de la landing page ?`)) {
                            return;
                          }
